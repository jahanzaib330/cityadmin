...
class AddBookers extends StatefulWidget {
  const AddBookers({super.key});

  @override
  State<AddBookers> createState() => _AddBookersState();
}

class _AddBookersState extends State<AddBookers> {

  @override
  Widget build(BuildContext context) {
    TextEditingController bookercode = TextEditingController();
    TextEditingController bookername = TextEditingController();
    TextEditingController bookeremail = TextEditingController();
    TextEditingController bookercontact = TextEditingController();
    TextEditingController bookerpassword = TextEditingController();

    Future<void> insertrecord() async {
      if(bookercode.text != "" || bookername.text != "" || bookeremail.text != "" || bookercontact.text != "" || bookerpassword.text != ""){
        try{
          String uri = "http://localhost/City_Channel_Api/Insert_Bookers.php";

          var res = await http.post(Uri.parse(uri), body: {
            "bookercode": bookercode.text,
            "bookername" : bookername.text,
            "bookeremail" : bookeremail.text,
            "bookercontact" : bookercontact.text,
            "bookerpassword" : bookerpassword.text
          });
          ...
          Stack(
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    width: 250,
                    child: TextField(
                      controller: bookeremail,
                      decoration: InputDecoration(
                          fillColor: Colors.grey.shade100,
                          filled: true,
                          hintText: 'Enter Booker Email',
                          border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(10))),
                    ),
                  ),
                  Row(
                    children: [
                      Container(
                        ...
                        width: 250,
                        child: TextField(
                          controller: bookercontact,
                          decoration: InputDecoration(
                              fillColor: Colors.grey.shade100,
                              filled: true,
                              hintText: 'Enter Booker Contact',
                              border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10))),
                        ),
                      ),
              ...
              Row(
                children:[
              Container(
              margin: EdgeInsets.only(left: 370, top: 360),
              width: 250,
                child: TextField(
                  controller: bookerpassword,
                 decoration: InputDecoration(
                    fillColor: Colors.grey.shade100,
                    filled: true,
                    hintText: 'Enter Booker Password',
                    border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10))),
                     ),
                     ),
