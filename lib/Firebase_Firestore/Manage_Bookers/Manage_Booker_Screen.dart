...
class ManageBooker extends StatefulWidget {
  const ManageBooker({super.key});

  @override
  State<ManageBooker> createState() => _ManageBookerState();
}

class _ManageBookerState extends State<ManageBooker> {
  List userdata = [];

 Future<void>getrecord() async {
    String uri = "http://localhost/City_Channel_Api/View_Booker.php";
    try{
                ...
                Container(
                  ...
                  child: DataTable(
                      columns: const <DataColumn>[
                        ...
                        DataColumn(
                          label: Text('Booker Email'),
                        ),
                        DataColumn(
                          label: Text('Booker Phone'),
                        ),
                        DataColumn(
                          label: Text('Booker Password'),
                        ),
                      ],
                      rows: List<DataRow>.generate(
                        userdata.length,
                          ...
                          cells: <DataCell>[
                            ...
                            DataCell(Text(userdata[index]["BookerEmail"]?? "")),
                            DataCell(Text(userdata[index]["BookerContact"]?? "")),
                            DataCell(Text(userdata[index]["BookerPassword"]?? "")),
